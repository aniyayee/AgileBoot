...
import com.github.core.common.exception.error.ErrorCodeInterface;
import lombok.Data;
...
public class AgileException extends RuntimeException {
    ...
    public AgileException(ErrorCodeInterface errorCode) {
        fillErrorCode(errorCode);
    }

    public AgileException(ErrorCodeInterface errorCode, Object... args) {
        fillErrorCode(errorCode, args);
    }

    /**
     * 注意  如果是try catch的情况下捕获异常 并转为AgileException的话  一定要填入Throwable e
     *
     * @param e         捕获到的原始异常
     * @param errorCode 错误码
     * @param args      错误详细信息参数
     */
    public AgileException(Throwable e, ErrorCodeInterface errorCode, Object... args) {
        super(e);
        fillErrorCode(errorCode, args);
    }
